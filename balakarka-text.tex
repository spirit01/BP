...
\section{Výpočty metodou EHT a jejich grafický výstup ve formě obrázku C.A.C.A.O. s použitím předvolených parametrů pro všechny atomy}
Pro účel vazebné analýzy byly všechny čtyři molekuly studovány prostřednictvím tzv. fragmentové analýzy. V jejich rámci byly provedeny kvantově chemické výpočty nejen pro kompletní molekuly, ale i pro podjednotky P=O a trojici bazálních ligandů. Výsledné MO pak byly vyjádřeny pomocí těchto fragmentových orbitalů. Míra interakce jednotlivých párů FMO z hlediska jejich příspěvků do překryvové populace. Všechny struktury molekul byly před výpočtem optimalizovány programem Gaussian \cite{g09} \footnote{B3LYP 6-31G*}.
%H4SIO4
% --------------------------------------------------------------------------
\subsection{Molekula H$_4$SiO$_4$}
Základní molekula pro čtyřkoordinovaný křemík je \ce{H4SiO4}, kde Si je koordinován čtyřmi kyslíky.
...
\end{figure} 
 ...
 \begin{figure}[h!]
\caption{Optimalizovaná struktura \ce{(H6SiO6)^{2-}}. }
  \center
