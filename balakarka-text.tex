...
level of extended Hückel method and density functional theory. Main
...
\begin{figure}
\begin{center}
\subfigure[Prostředí kolem šestikoordinovaného Si, první pozorovaný typ koordinace \cite{Styskalik2015thesis}.]{\includegraphics[width=10cm]{si_koordinovane_6_P.png} \label{img1}}

\subfigure[Prostředí kolem šestikoordinovaného Si, druhý pozorovaný typ koordinace \cite{Styskalik2015thesis}.]{\includegraphics[width=10cm]{si_koordinovany_6_C.png}\label{img2}}
...
\subfigure[Optimalizovaná struktura \ce{H3SiO3CH3}.]{\includegraphics[width=10cm]{si(oh)3ch3_obr.png}\label{obr_sioh3ch3_opt_struktura}}
\label{obr_h4sio4_vysledky_I}
\end{center}
\end{figure}
...
\subfigure[Optimalizovaná struktura \ce{(H6SiO6)^{2-}}.]{\includegraphics[width=10cm]{obr_h6sio6.png}\label{obr_h6sio6_opt_struktura}}
